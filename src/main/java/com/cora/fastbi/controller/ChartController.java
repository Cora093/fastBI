...
import com.cora.fastbi.model.dto.chart.ChartAddRequest;
import com.cora.fastbi.model.dto.chart.ChartEditRequest;
import com.cora.fastbi.model.dto.chart.ChartQueryRequest;
import com.cora.fastbi.model.dto.chart.ChartUpdateRequest;
...
public class ChartController {
    ...
    public BaseResponse<Page<Chart>> listMyChartByPage(@RequestBody ChartQueryRequest chartQueryRequest,
        ...
        long size = chartQueryRequest.getPageSize();
        // 按照创建时间倒序
        chartQueryRequest.setSortField("create_time");
        chartQueryRequest.setSortOrder("desc");
        // 限制爬虫
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
        Page<Chart> chartPage = chartService.page(new Page<>(current, size),
                getQueryWrapper(chartQueryRequest));
